...
- **Google Firebase** — Analytics, Crashlytics, Performance Monitoring, and Remote Config. See [Firebase Privacy](https://firebase.google.com/support/privacy) and the [Google Privacy Policy](https://policies.google.com/privacy).
- **Apple StoreKit / App Store** — used to process Dice Pro subscription purchases and to validate and restore your entitlement. See the [Apple Privacy Policy](https://www.apple.com/legal/privacy/).
